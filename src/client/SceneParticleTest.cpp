...
SceneParticleTest::~SceneParticleTest()
{
    EndScene();
}

AkBool SceneParticleTest::BeginScene()
{
    using namespace std;
...
AkBool SceneParticleTest::EndScene()
{
...
void SceneParticleTest::FinalUpdate()
{
}

void SceneParticleTest::Render()
{
    GRenderer->RenderParticle(_pParticle, _pDBHandle);
}

void SceneParticleTest::RenderShadow()
{
}
