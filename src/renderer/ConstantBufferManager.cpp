...
ConstantBufferProperty_t g_pConstantbufferProperties[] =
{
	...
	CONSTANT_BUFFER_TYPE::CONSTANT_BUFFER_TYPE_PARTICLE_SPRITE, sizeof(ParticleSpriteConstantBuffer_t),
	CONSTANT_BUFFER_TYPE::CONSTANT_BUFFER_TYPE_VOLUME_CLOUD, sizeof(VolumeCloudConstantBuffer_t),
};
