...
AkBool FSkyboxObject::CreateMesh()
{
	...
	pVertices[0] = Vector3(-1.0f, 1.0f, -1.0f) * _fScale;
	pVertices[1] = Vector3(-1.0f, 1.0f, 1.0f) * _fScale;
	pVertices[2] = Vector3(1.0f, 1.0f, 1.0f) * _fScale;
	pVertices[3] = Vector3(1.0f, 1.0f, -1.0f) * _fScale;
	pVertices[4] = Vector3(-1.0f, -1.0f, -1.0f) * _fScale;
	pVertices[5] = Vector3(1.0f, -1.0f, -1.0f) * _fScale;
	pVertices[6] = Vector3(1.0f, -1.0f, 1.0f) * _fScale;
	pVertices[7] = Vector3(-1.0f, -1.0f, 1.0f) * _fScale;
	pVertices[8] = Vector3(-1.0f, -1.0f, -1.0f) * _fScale;
	pVertices[9] = Vector3(-1.0f, 1.0f, -1.0f) * _fScale;
	pVertices[10] = Vector3(1.0f, 1.0f, -1.0f) * _fScale;
	pVertices[11] = Vector3(1.0f, -1.0f, -1.0f) * _fScale;
	pVertices[12] = Vector3(-1.0f, -1.0f, 1.0f) * _fScale;
	pVertices[13] = Vector3(1.0f, -1.0f, 1.0f) * _fScale;
	pVertices[14] = Vector3(1.0f, 1.0f, 1.0f) * _fScale;
	pVertices[15] = Vector3(-1.0f, 1.0f, 1.0f) * _fScale;
	pVertices[16] = Vector3(-1.0f, -1.0f, 1.0f) * _fScale;
	pVertices[17] = Vector3(-1.0f, 1.0f, 1.0f) * _fScale;
	pVertices[18] = Vector3(-1.0f, 1.0f, -1.0f) * _fScale;
	pVertices[19] = Vector3(-1.0f, -1.0f, -1.0f) * _fScale;
	pVertices[20] = Vector3(1.0f, -1.0f, 1.0f) * _fScale;
	pVertices[21] = Vector3(1.0f, -1.0f, -1.0f) * _fScale;
	pVertices[22] = Vector3(1.0f, 1.0f, -1.0f) * _fScale;
	pVertices[23] = Vector3(1.0f, 1.0f, 1.0f) * _fScale;
