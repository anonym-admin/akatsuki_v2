...
enum class RENDER_ITEM_TYPE
{
	...
	RENDER_ITEM_TYPE_MESH_OBJ_DEPTH_MAP,
	RENDER_ITEM_TYPE_SKINNED_MESH_OBJ_DEPTH_MAP,
	RENDER_ITEM_TYPE_BILLBOARD_DEPTH_MAP,
	RENDER_ITEM_TYPE_TERRAIN_OBJ_DEPTH_MAP,

	RENDER_ITEM_TYPE_MESH_OBJ_SHADOW_MAP,
	RENDER_ITEM_TYPE_SKINNED_MESH_OBJ_SHADOW_MAP,
	RENDER_ITEM_TYPE_BILLBOARD_SHADOW_MAP,
	RENDER_ITEM_TYPE_TERRAIN_OBJ_SHADOW_MAP,
};
